...
function Login() {
    ...
    return (
        <>
            <div class="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-2 sm:justify-start xs:py-2" >
                <div class="lg:p-10 xs:p-2 sm:p-1 mx-auto md:w-full md:max-w-md p-4">

                    <h1 class="font-bold text-center text-2xl mb-5">SCANIA CONTROL</h1>
